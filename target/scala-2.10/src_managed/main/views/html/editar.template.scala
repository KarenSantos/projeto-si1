...
<div id="top1"><!-- coluna de periodos -->
	"""),_display_(Seq[Any](/*10.3*/if(planejador.isInvertido())/*10.31*/{_display_(Seq[Any](format.raw/*10.32*/("""
		<a onclick="inverter('"""),_display_(Seq[Any](/*11.26*/numPeriodo)),format.raw/*11.36*/("""')" title="Ordenação crescente"><div id="inverter"> ^ </div></a>
	""")))}/*12.4*/else/*12.9*/{_display_(Seq[Any](format.raw/*12.10*/("""
		<a onclick="inverter('"""),_display_(Seq[Any](/*13.26*/numPeriodo)),format.raw/*13.36*/("""')" title="Ordenação decrescente"><div id="inverter"> v </div></a>
	""")))})),format.raw/*14.3*/("""
	<h2>Períodos</h2>
</div>
<div id="col1">
...
""")))})))}
    ...
    def ref: this.type = this
                ...
                /*
                    -- GENERATED --
                    DATE: Tue Mar 04 14:12:49 GMT-03:00 2014
                    SOURCE: E:/Workspace/projeto-si1/app/views/editar.scala.html
                    HASH: 2cfc9469140073b1fab7b3df622ed7e97414c191
